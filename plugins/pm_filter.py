...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('Update Channel', url='https://t.me/Movies4youbackup'),
                ]
                ]
            await query.message.edit(text="<b>Developer : <a href='https://t.me/Movies_4you'>會؄𝚂𝚄𝚁𝙰𝙹؄會</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\n Update Channel : <a href='https://t.me/Movies4youbackup'>ErrorXBotz</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                     InlineKeyboardButton('📥 More Bots 📥', url='https://t.me/Movies4youbackup'),
                    ]
                    ]
