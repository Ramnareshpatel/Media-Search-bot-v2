            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        ...
                        InlineKeyboardButton('💌 𝗝𝗢𝗜𝗡 💌', url='https://Movies4youbackup')
                    ]
                    ]
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("📺 𝗦𝗘𝗔𝗥𝗖𝗛 𝗛𝗘𝗥𝗘 🔍", switch_inline_query_current_chat=''),
                        InlineKeyboardButton("📥 𝗢𝗧𝗧 𝗠𝗢𝗩𝗜𝗘𝗦 📥", url='https://t.me/+4Gx1t6T3uWNkY2U1'),
                    ],
                   [
...
async def bot_info(bot, message):
    buttons = [
        [
            InlineKeyboardButton('💌 𝗝𝗢𝗜𝗡 💌', url='https://t.me/Movies4youBackup'),
            InlineKeyboardButton('📥 𝗚𝗥𝗢𝗨𝗣 📥', url='https://t.me/Movies_4you')
        ]
        ]
    await message.reply(text="<b>Developer : <a href='https://t.me/Movies_4you'>會؄𝚂𝚄𝚁𝙰𝙹؄會</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nSource Code : <a href='https://t.me/Movies4youBackup'>Click here</a>\nUpdate Channel : <a href='https://t.me/Movies_4you'>𝙹𝙾𝙸𝙽 𝙽𝙾𝚆</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
...
async def bot_info(bot, message):
    buttons = [
        [
            InlineKeyboardButton('💌 𝗝𝗢𝗜𝗡 💌', url='https://t.me/Movies4youBackup'),
            InlineKeyboardButton('࿐ 𝗦𝗨𝗣𝗣𝗢𝗨𝗥𝗧 𝗚𝗥𝗢𝗨𝗣 ࿐', url='https://t.me/Movies_4you')
        ]
        ]
